package example.yuan.com.factory;
...
public class Factory {
    ...
    /**
     * 用来进行错误的Code解析，把网络返回的Code值进行统一的规划
     * 返回一个统一的String资源
     * @param model RspMode
     * @param callback  DataSource.FailedCallback用来返回一个错误的资源id
     */
    ...
    private static void decodeRspCode(@StringRes final int resId,
                                       DataSource.FailedCallback callback ){
        if (callback!=null){
